...
public class Creature extends Actor
{
    ...
    /**
     * Creature is the constructor for objects of the Creature class
     * 
    ...
    public Creature()
    {
        ...
        creatureBar = new HealthBar(healthNumber,healthNumber,0);
    }
    ...
    /**
     * getHeathBar gets the creatire bar for that creature
     * 
     * @param there are no parameters
     * @return returns a health bar object for a creature
     */
    /**
    ...
    /**
     * getPlayerOwner returns which player owns the Creature
     * 
     * @param there are no parameters
     * @return an integer that represents which player owns the creature
     * 
     */
    /**
