...
public class CreatureWorld extends World
{
    ...
    /**
     * CreatureWorld is the constructor for creature world objects
     * 
    ...
    /**
     * prepareCreatures perpares a pikachu, charmander and two buttons at certain locations
     * 
     * @param there are no prameters
     * @return nothing is returned 
     */
    /**
    ...
    public void prepareCreatures(){
        ...
        addObject(new Button( Color.RED, 50 ), getWidth()/2 + 50, getHeight() - 100);
    ...
    /**
     * getPlayerOne returns a creature object 
     * 
     * @param there are no parameter
     * @return returns a playerOneCreature 
     */
    /**
    ...
    /**
     * getPlayerTwo returns a creature object 
     * 
     * @param there are no parameter
     * @return returns a playerTwoCreature 
     */
    /**
