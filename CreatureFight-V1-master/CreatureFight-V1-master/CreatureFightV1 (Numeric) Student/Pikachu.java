...
{
    /**
     * Pikachu is the constructor for charmander type objects
     * 
     * @param the parmater is called world that is a world datatype and is used to get world
     ...
     */
    /** 
     * Pikachu is the constructor for Pikachu type objects 
     * 
     * @param world holsds a world object
     * @return nothing is returned 
     */ 
    ...
    public void act() 
    {
        ...
        if(getHealthBar().getCurrent() <=0 ){
            ...
            playerWorld.showText("Pikachu Has Fainted",getWorld().getWidth()/2,getWorld().getHeight()/2 + 26);
